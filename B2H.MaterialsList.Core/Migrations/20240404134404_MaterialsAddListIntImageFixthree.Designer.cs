...
namespace B2H.MaterialsList.Core.Migrations
{
    ...
    [Migration("20240404134404_MaterialsAddListIntImageFixthree")]
    partial class MaterialsAddListIntImageFixthree
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MaterialsList.Backend.Models.Image", b =>
                {
                    ...
                    b.HasIndex(new[] { "MaterialId" }, "IX_Images_MaterialId");
            ...
            modelBuilder.Entity("MaterialsList.Backend.Models.Material", b =>
                {
                    ...
                    b.HasIndex(new[] { "ImagesIds" }, "IX_Materials_ImagesIds");
