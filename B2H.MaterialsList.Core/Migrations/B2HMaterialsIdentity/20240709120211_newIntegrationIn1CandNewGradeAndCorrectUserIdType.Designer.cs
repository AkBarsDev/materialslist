...
namespace B2H.MaterialsList.Core.Migrations.B2HMaterialsIdentity
{
    ...
    [Migration("20240709120211_newIntegrationIn1CandNewGradeAndCorrectUserIdType")]
    partial class newIntegrationIn1CandNewGradeAndCorrectUserIdType
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("B2H.MaterialsList.Core.Models.Category", b =>
                {
                    ...
                    b.Property<Guid>("IntegrationCategoryId")
                        .HasColumnType("uuid");
